...
app.register_blueprint(urls2_blueprint,url_prefix='/getVoices')
app.register_blueprint(generate_blueprint,url_prefix='/generate')
app.register_blueprint(getAudios_blueprint,url_prefix='/getAudios')
app.register_blueprint(urls6_blueprint,url_prefix='/getVoicesAvalaible')
